## ABOUT ##
Take organized notes on a CLI interface.
These notes have the ability to be tagged for quick finding as well as a unique number id for guarenteed results.
